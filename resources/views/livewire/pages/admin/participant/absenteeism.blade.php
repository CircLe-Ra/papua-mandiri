...
$receptions = computed(function () {
    return Reception::where('period', 'like', '%' . $this->search . '%')
        ...
        ->latest()->paginate($this->show, pageName: 'receptions-absent-page');
});
    ...
    <div class="grid-cols-1 lg:grid-cols-3 grid gap-2 ">
        <div class="col-span-3 ">
            <x-card class="mt-2 w-full ">
                <x-slot name="header">
                    Daftar Periode
                    <p class="text-sm text-gray-600 dark:text-gray-300">Silahkan pilih periode aktif untuk melihat absensi peserta.</p>
                </x-slot>
