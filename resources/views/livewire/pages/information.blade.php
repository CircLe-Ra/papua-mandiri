...
<div>
    ...
    <div class="relative mt-2 border-2 border-dashed border-gray-400 dark:border-gray-600 rounded-lg pb-[43.10%] w-full">
        <div class="absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center">
            <div class="text-center text-white font-bold">
                ...
                <p class="mt-2">Pendaftaran belum dibuka untuk saat ini.</p>
            </div>
        </div>
    </div>
</div>
