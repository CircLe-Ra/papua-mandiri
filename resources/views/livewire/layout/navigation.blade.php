    ...
    <div>
        ...
        <aside id="sidebar-multi-level-sidebar"  class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-gray-800 border-r border-gray-700 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
            ...
            <ul class="space-y-2 font-medium">
                ...
                @role('pimpinan||admin')
                <li>
                    <a href="{{  route('admin.dashboard') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('admin.dashboard') ? 'bg-gray-800 dark:bg-gray-700' : '' }}" wire:navigate>
                ...
                @role('admin')
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg group hover:bg-gray-700 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('admin.master-data*') ? 'bg-gray-800 dark:bg-gray-700' : '' }}" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                ...
                <li>
                    <a  wire:navigate href="{{ route('admin.reception') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('admin.reception*') ? 'bg-gray-800 dark:bg-gray-700' : '' }}" >
                ...
                <li>
                    <a wire:navigate href="{{ route('admin.participants') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('admin.participants*') ? 'bg-gray-800 dark:bg-gray-700' : '' }}">
                ...
                <li>
                    <a wire:navigate href="{{ route('admin.participant.absenteeism') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('admin.participant.absenteeism*') ? 'bg-gray-800 dark:bg-gray-700' : '' }}">
                ...
                @role('peserta')
                <li>
                    <a href="{{  route('dashboard') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('dashboard') ? 'bg-gray-800 dark:bg-gray-700' : '' }}" wire:navigate>
                ...
                <li>
                    <a wire:navigate href="{{ route('participant.registration') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('participant.registration*') ? 'bg-gray-800 dark:bg-gray-700' : '' }}">
                ...
                <li>
                    <a wire:navigate href="{{ route('participant.certificate.download') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('participant.certificate.download') ? 'bg-gray-800 dark:bg-gray-700' : '' }}">
                ...
                @role('pimpinan||admin')
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg group hover:bg-gray-800 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('report*') ? 'bg-gray-800 dark:bg-gray-700' : '' }}" aria-controls="dropdown-example-1" data-collapse-toggle="dropdown-example-1">
