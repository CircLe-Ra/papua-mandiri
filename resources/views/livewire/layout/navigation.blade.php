    ...
    <div>
            ...
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        <div class="bg-gray-800 lg:flex dark:bg-gray-800 md:hidden" sidebar-bottom-menu="" bis_skin_checked="1"  x-cloak>
                            <label class="inline-flex items-center cursor-pointer w-full">
                                ...
                                <span class="text-sm font-medium text-gray-300 ms-3 dark:text-gray-300">
        ...
        <aside id="sidebar-multi-level-sidebar"  class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-gray-800 border-r border-gray-700 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
            <div class="h-full px-2 pb-4 overflow-y-auto bg-gray-800 dark:bg-gray-800">
            <ul class="space-y-2 font-medium">

                @role('pimpinan||admin')
                <li>
                    <a href="{{  route('admin.dashboard') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('admin.dashboard') ? 'bg-gray-700 dark:bg-gray-700' : '' }}" wire:navigate>
                        <svg class="w-5 h-5 text-blue-500 transition duration-75"  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                @role('admin')
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg group hover:bg-gray-700 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('admin.master-data*') ? 'bg-gray-700 dark:bg-gray-700' : '' }}" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                        <svg class="flex-shrink-0 w-5 h-5 text-blue-500 transition duration-75" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 10c4.418 0 8-1.79 8-4s-3.582-4-8-4s-8 1.79-8 4s3.582 4 8 4"/><path fill="currentColor" d="M4 12v6c0 2.21 3.582 4 8 4s8-1.79 8-4v-6c0 2.21-3.582 4-8 4s-8-1.79-8-4" opacity="0.5"/><path fill="currentColor" d="M4 6v6c0 2.21 3.582 4 8 4s8-1.79 8-4V6c0 2.21-3.582 4-8 4S4 8.21 4 6" opacity="0.7"/></svg>
                    ...
                    <ul id="dropdown-example" class=" py-2 space-y-2 {{ request()->routeIs('admin.master-data*') ? '' : 'hidden' }}">
                        <li>
                            <a wire:navigate href="{{ route('admin.master-data.program') }}" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-700 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('admin.master-data.program') ? 'font-bold' : '' }}" >Data Program</a>
                        </li>
                        <li>
                            <a wire:navigate href="{{ route('admin.master-data.religion') }}" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-700 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('admin.master-data.religion') ? 'font-bold' : '' }}">Data Agama</a>
                        </li>
                        <li>
                            <a wire:navigate href="{{ route('admin.master-data.user') }}" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-700 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('admin.master-data.user') ? 'font-bold' : '' }}">Data Pengguna</a>
                        </li>
                        <li>
                            <a wire:navigate href="{{ route('admin.master-data.role') }}" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-700 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('admin.master-data.role') ? 'font-bold' : '' }}">Data Role</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a  wire:navigate href="{{ route('admin.reception') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('admin.reception*') ? 'bg-gray-700 dark:bg-gray-700' : '' }}" >
                        <svg class="flex-shrink-0 w-5 h-5 text-blue-500 transition duration-75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" fill-opacity="0.25" d="M5 17h4a3 3 0 0 1 3 3V10c0-2.828 0-4.243-.879-5.121C10.243 4 8.828 4 6 4H5c-.943 0-1.414 0-1.707.293S3 5.057 3 6v9c0 .943 0 1.414.293 1.707S4.057 17 5 17"/><path fill="currentColor" d="M19 17h-3a3 3 0 0 0-3 3V10c0-2.828 0-4.243.879-5.121C14.757 4 16.172 4 19 4c.943 0 1.414 0 1.707.293S21 5.057 21 6v9c0 .943 0 1.414-.293 1.707S19.943 17 19 17M5 4.15A.15.15 0 0 1 5.15 4h2.7a.15.15 0 0 1 .15.15v4.246a.25.25 0 0 1-.427.177l-.896-.896a.25.25 0 0 0-.354 0l-.896.896A.25.25 0 0 1 5 8.396z"/></svg>

                        <span class="flex-1 ms-3 whitespace-nowrap">Pembukaan</span>
                    </a>
                </li>
                <li>
                    <a wire:navigate href="{{ route('admin.participants') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('admin.participants*') ? 'bg-gray-700 dark:bg-gray-700' : '' }}">
                        <svg class="flex-shrink-0 w-5 h-5 text-blue-500 transition duration-75" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256"><path fill="currentColor" d="m226.53 56.41l-96-32a8 8 0 0 0-5.06 0l-96 32A8 8 0 0 0 24 64v80a8 8 0 0 0 16 0V75.1l33.59 11.19a64 64 0 0 0 20.65 88.05c-18 7.06-33.56 19.83-44.94 37.29a8 8 0 1 0 13.4 8.74C77.77 197.25 101.57 184 128 184s50.23 13.25 65.3 36.37a8 8 0 0 0 13.4-8.74c-11.38-17.46-27-30.23-44.94-37.29a64 64 0 0 0 20.65-88l44.12-14.7a8 8 0 0 0 0-15.18ZM176 120a48 48 0 1 1-86.65-28.45l36.12 12a8 8 0 0 0 5.06 0l36.12-12A47.9 47.9 0 0 1 176 120"/></svg>
                        <span class="flex-1 ms-3 whitespace-nowrap">Peserta Kursus</span>
                    </a>
                </li>
                <li>
                    <a wire:navigate href="{{ route('admin.participant.absenteeism') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('admin.participant.absenteeism*') ? 'bg-gray-700 dark:bg-gray-700' : '' }}">
                ...
                @role('peserta')
                <li>
                    <a href="{{  route('dashboard') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('dashboard') ? 'bg-gray-700 dark:bg-gray-700' : '' }}" wire:navigate>
                        <svg class="w-5 h-5 text-blue-500 transition duration-75"  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path fill="currentColor" fill-rule="evenodd" d="M19 11a2 2 0 0 1 1.995 1.85L21 13v6a2 2 0 0 1-1.85 1.995L19 21h-4a2 2 0 0 1-1.995-1.85L13 19v-6a2 2 0 0 1 1.85-1.995L15 11zm0-8a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z" class="duoicon-secondary-layer" opacity="0.3" />
                            <path fill="currentColor" fill-rule="evenodd" d="M9 3a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z" class="duoicon-primary-layer" />
                            <path fill="currentColor" fill-rule="evenodd" d="M9 15a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-2a2 2 0 0 1 2-2z" class="duoicon-secondary-layer" opacity="0.3" />
                ...
                <li>
                    <a wire:navigate href="{{ route('participant.registration') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('participant.registration*') ? 'bg-gray-700 dark:bg-gray-700' : '' }}">
                        <svg  class="flex-shrink-0 w-5 h-5 text-blue-500 transition duration-75" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
                ...
                <li>
                    <a wire:navigate href="{{ route('participant.certificate.download') }}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 group {{ request()->routeIs('participant.certificate.download') ? 'bg-gray-700 dark:bg-gray-700' : '' }}">
                ...
                @role('pimpinan||admin')
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg group hover:bg-gray-800 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('report*') ? 'bg-gray-700 dark:bg-gray-700' : '' }}" aria-controls="dropdown-example-1" data-collapse-toggle="dropdown-example-1">
                        <svg class="flex-shrink-0 w-5 h-5 text-blue-500 transition duration-75" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><defs><mask id="ipTTableReport1"><g fill="none" stroke="#fff" stroke-linejoin="round" stroke-width="4"><path fill="#555555" d="M5 7a3 3 0 0 1 3-3h24a3 3 0 0 1 3 3v37H8a3 3 0 0 1-3-3z"/><path d="M35 24a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v17a3 3 0 0 1-3 3h-5z"/><path stroke-linecap="round" d="M11 12h8m-8 7h12"/></g></mask></defs><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipTTableReport1)"/></svg>
                    ...
                    <ul id="dropdown-example-1" class=" py-2 space-y-2 {{ request()->routeIs('report*') ? '' : 'hidden' }}">
                        <li>
                            <a wire:navigate href="{{ route('report.absenteeism') }}" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-700 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('report.absenteeism') ? 'font-bold' : '' }}" >Absensi</a>
                        </li>
                    </ul>
                </li>
                @endrole
